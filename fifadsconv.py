...
tlb2pngarg.add_argument("output", metavar="out.png", type=str, help="output name")
...
tbf2pngarg.add_argument("output", metavar="out.png", type=str, help="output image")
...
png2tlbarg.add_argument("output", metavar="out.tlb", type=argparse.FileType("wb"), help="output file")
...
png2tbfarg.add_argument("output", metavar="out.tbf", type=argparse.FileType("wb"), help="output file")
...
png2dstarg.add_argument("output", metavar="out.dst", type=argparse.FileType("wb"), help="output file")
...
dst2pngarg.add_argument("output", metavar="out.png", type=str, help="output name")
